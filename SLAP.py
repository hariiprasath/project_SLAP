...
#function to split the string passed from c into seperate results
...
#functions to extract song name and artist name from the seperated result string
...
songSearchBut = Button(mainWindow, text= "Search by Song", bg="light blue", bd=1)
songSearchBut.place(x=40, y=110, height=40, width=165)

artistSearchBut = Button(mainWindow, text= "Search by Artist", bg="light blue", bd=1)
